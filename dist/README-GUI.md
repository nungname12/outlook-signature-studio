...
The default signature values are written as `REG_EXPAND_SZ` for Outlook compatibility. The app does not modify Ribbon customization or signature policy values.
